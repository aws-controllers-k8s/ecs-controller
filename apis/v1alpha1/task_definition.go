...
// +kubebuilder:printcolumn:name="FAMILY",type=string,priority=0,JSONPath=`.spec.family`
// +kubebuilder:printcolumn:name="CPU",type=string,priority=0,JSONPath=`.spec.cpu`
// +kubebuilder:printcolumn:name="MEMORY",type=string,priority=0,JSONPath=`.spec.memory`
// +kubebuilder:printcolumn:name="NETWORKMODE",type=string,priority=0,JSONPath=`.spec.networkMode`
