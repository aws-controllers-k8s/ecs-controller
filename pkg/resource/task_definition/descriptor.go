...
const (
	finalizerString = "finalizers.ecs.services.k8s.aws/TaskDefinition"
)

var (
	GroupVersionResource = svcapitypes.GroupVersion.WithResource("taskdefinitions")
...
func (d *resourceDescriptor) EmptyRuntimeObject() rtclient.Object {
	return &svcapitypes.TaskDefinition{}
}
...
func (d *resourceDescriptor) ResourceFromRuntimeObject(
	...
	return &resource{
		ko: obj.(*svcapitypes.TaskDefinition),
	}
}
