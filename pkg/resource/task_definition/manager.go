...
// +kubebuilder:rbac:groups=ecs.services.k8s.aws,resources=taskdefinitions,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ecs.services.k8s.aws,resources=taskdefinitions/status,verbs=get;update;patch
