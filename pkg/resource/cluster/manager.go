...
// +kubebuilder:rbac:groups=ecs.services.k8s.aws,resources=clusters,verbs=get;list;watch;create;update;patch;delete
// +kubebuilder:rbac:groups=ecs.services.k8s.aws,resources=clusters/status,verbs=get;update;patch
